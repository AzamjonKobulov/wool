    ...
    <section id="blog">
      <div className="max-w-5xl mx-auto space-y-3.5 mt-8 px-2.5">
        ...
        <div className="flex items-center gap-5 font-semibold">
          <button>Все</button>
          <button className="text-brand-purple-10">Новости</button>
          <button className="text-brand-purple-10">Обзоры</button>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-7">
          ...
          {/* Blogs */}
          <ul className="divide-y divide-brand-gray-30 border-y border-brand-gray-30">
            {/* Blog 1 */}
            <li className="space-y-2.5 w-full font-semibold py-2.5">
              {/* Top */}
